  ...
  return (
    <section className="mt-8 rounded-[28px] bg-neutral-900 p-6 text-white sm:p-8">
      ...
      <div className="mt-6 grid gap-3 text-sm text-neutral-300 sm:grid-cols-2">
        ...
        <p>
          <span className="heartbeat mr-1 inline-block">❤️</span> Estimated
          heartbeats: <b className="tabular text-white">{fmt(heart)}</b>
          {mode === "alive" && (
      ...
      <section className="mx-auto mt-12 max-w-4xl animate-[fade_.4s_ease]">
        ...
        <div className="mt-8 rounded-[28px] border border-neutral-200 bg-white p-6 sm:p-8">
          ...
          <p className="mt-3 text-lg leading-8 text-neutral-700">
            ...
            thousands of mornings and nights, and watched the world change for{" "}
            {fmt(t.hours)} hours. The number keeps moving because your story
            does too.
          </p>
        </div>
...
export default function Home() {
  const [mode, setMode] = useState("alive"),
    [birth, setBirth] = useState({ d: "", m: "", y: "" }),
    [death, setDeath] = useState({ d: "", m: "", y: "" }),
  ...
  function calc() {
    ...
    setResult({ start: b, end, mode, name });
  }
